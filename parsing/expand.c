...
/*   Updated: 2023/09/03 21:22:19 by fouaouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	if_else_expand(t_read *readline, t_variables *var, char **env)
{
...
void	else_expand(t_read *readline, t_variables *var, char **env)
{
	var->count = 0;
	if (readline->input[var->i] == '$')
		if_else_expand(readline, var, env);
	else
		readline->exp = ft_strjoin_char(readline->exp,
				readline->input[var->i++]);
}
